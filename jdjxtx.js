 ...
 *打开京喜工厂，收集电力，提示获取cookie成功
 * 打开京喜财富岛，手动成功提现一次，提示获取cookie成功
 * 手动任意完成，提示获取cookie成功，然后退出运行脚本

  主机名 = wq.jd.com, m.jingxi.com
  ...
  # 懒人
  [脚本]
  http-request ^https\:\/\/wq\.jd\.com\/cubeactive\/farm\/dotask 脚本路径=https://raw.githubusercontent.com/whyour/hundun/master/quanx/jx_tokens .js, requires-body=false, timeout=10, tag=京喜令牌
  http-request ^https\:\/\/m\.jingxi\.com\/dreamfactory\/generator\/CollectCurrentElectricity script-path=https://raw.githubusercontent.com/whyour/hundun/master/quanx/jx_tokens .js, requires-body=false, timeout=10, tag=京喜令牌
...
!(异步() => {
  如果 (!getCookies()) 返回；
  如果 (!getTokens()) 返回；
  for (让 i = 0; i < $.cookieArr.length; i++) {
...
函数 taskUrl(function_path, body) {
  返回 {
    url:`${JD_API_HOST}jxcfd/${function_path}?strZone=jxcfd&bizCode=jxcfd&source=jxcfd&dwEnv=7&_cfd_t=${Date.now()}&ptag=&${body}&_stk=_cf%2Code%2PaddCydwCfd%2PaddCwEn %2CdwIsCreateToken%2Cptag%2Csource%2CstrPgUUNum%2CstrPgtimestamp%2CstrPhoneID%2CstrZone&_ste=1&_=${Date.now()}&sceneval=2&g_login_type=1&g_ty=ls`,
    标题：{
      Cookie: $.currentCookie,
      接受： ”*/*”，
      连接：“保持活动”，
      推荐人："https://st.jingxi.com/fortune_island/cash.html?jxsid=16115391812299482601&_f_i_jxapp=1",
      "Accept-Encoding": "gzip, deflate, br",
      主持人：“m.jingxi.com”，
      "用户代理":"jdpingou;iPhone;4.1.4;14.3;9f08e3faf2c0b4e72900552400dfad2e7b2273ba;network/wifi;model/iPhone11,6;appBuild/100415;ADID/0000000000000ha0-support0000000ha0-support00000000ha0000000000000000000000000000000000000000000000 /0;pushNoticeIsOpen/0;hasOCPay/0;supportBestPay/0;session/428;pap/JA2019_3111789;brand/apple;supportJDSHWK/1;Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1。 15 (KHTML, like Gecko) Mobile/15E148",
